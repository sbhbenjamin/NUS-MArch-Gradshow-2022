export const themes = [
  { supervisor: 'Assoc. Prof. François Blanciak (Dr.)', theme: 'FORM' },
  {
    supervisor: 'Adj. Assoc. Prof. Hans Brouwer',
    theme: 'IN PURSUIT OF OPTIMISM',
  },
  { supervisor: 'Assoc. Prof. Cheah Kok Ming', theme: 'ANTIFRAGILE FRAMING' },
  {
  ...
  { supervisor: 'Adj. Assoc. Prof. Khoo Peng Beng', theme: 'HOLON STUDIO' },
  {
  ...
  { supervisor: 'Assoc. Prof. Joseph Lim (Dr.)', theme: 'NEW TYPES' },
  {
  ...
  { supervisor: 'Assoc. Prof. Shinya Okuda', theme: 'NATURE UNFOLD' },
  { supervisor: 'Assoc Prof. Ong Ker-Shing', theme: 'DIRT, FORM, PERFORMANCE' },
  { supervisor: 'Assoc. Prof. Tsuto Sakamoto', theme: 'ASSEMBLAGE' },
  {
  ...
  { supervisor: 'Adj. Asst. Prof. Tiah Nan Chyuan', theme: 'ISLAND PEOPLE' },
  {
